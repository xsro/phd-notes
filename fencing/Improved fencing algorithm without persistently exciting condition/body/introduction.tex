...
% 这一点以后可以细说一下，比如初始状态所有智能体在一条线上如....1...0...2....
% 如果像formation-tracking 一样转化为镇定问题，期望队形是...2...0...1....
% 如果不加一些随机信号，只用一般的镇定策略，那么这就无法实现合围。
...
It is shown that the target must be maneuvering, and the corresponding condition is characterized using persistently exciting  (PE) condition.
