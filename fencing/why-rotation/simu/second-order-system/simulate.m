% simulate.m
% 仿真系统: \ddot{x} + k_1 \dot{x} + k_2 x = 0, 其中 x \in \mathbb{R}^2
...
% 定义 ODE 函数
% 状态向量 y = [x1, x2, v1, v2]
% dy/dt = [v1; v2; -k1*v1 - k2*x1; -k1*v2 - k2*x2]
odefun = @(t, y) [y(3); y(4); -k1*y(3) - k2*y(1); -k1*y(4) - k2*y(2)];
...
title('atan2(x(2), x(1)) 随时间的变化 (k_1 = k_2 = 1)');
grid on;