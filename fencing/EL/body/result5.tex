\subsection{Controller 5: Robust Adaptive Control with Constant Gain}
\label{sec: controller5}
...
\S\ref{sec: controller6} and \S\ref{sec: controller7} for variants that relax the
gain condition.
