...
import json
json_data = {
    'high_frequency_branch': {
        'description': 'High-frequency breathing limit cycle (case3.py IC)',
        'omega_ratio': '≈ 3.5',
        'period_k1_k2_0.5': '2.486 s',
        'data': DOC_DATA_HIGH
    },
    'low_frequency_branch': {
        'description': 'Low-frequency breathing limit cycle (perturbed pentagon IC, pert=2.0)',
        'omega_ratio': '≈ 1.42',
        'period_k1_k2_0.5': '6.24 s',
        'data': DOC_DATA_LOW
    },
    'rotating_equilibrium': {
        'description': 'Rotating equilibrium (regular pentagon IC)',
        'omega_ratio': '= 1.0',
        'period_k1_k2_0.5': '8.886 s (= 2π/√k₂)',
        'data': DOC_DATA_ROT
    },
    'verification': verify_results
}
with open('data/bifurcation_data.json', 'w') as f:
    json.dump(json_data, f, indent=2, default=str)
print('✓ Raw data saved to data/bifurcation_data.json')